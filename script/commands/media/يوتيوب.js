...
هذا الإصدار أيضًا يتعامل مع فشل "ytdl-core" عند تحميل الملف بحيث لا يختفي الأمر بصمت، ويعرض السبب الفعلي في المحادثة. مكتبة "yt-search" الموجودة عندك إصدارها "2.13.1" وتدعم البحث بالطريقة المستخدمة في الكود.